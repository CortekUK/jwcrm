...
function AdminDashboard() {
  ...
  // Show loading while redirecting to correct dashboard
  if (selectedRole && selectedRole !== "admin") {
    return (
...
// Export the admin dashboard directly - other role dashboards have their own routes now
