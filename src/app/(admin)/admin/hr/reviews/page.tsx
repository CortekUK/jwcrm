...
export default function AdminQuarterlyReviewsPage() {
          ...
          <div className={isRtl ? "text-right" : ""}>
            ...
            <p className={`text-sm text-[#777777] ${isRtl ? "mr-9" : "ml-9"}`}>
              {employeeId && employeeName
                ...
                : t("hr:managePerformanceReviews", "Manage monthly and quarterly employee performance reviews")}
            </p>
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <Button
              ...
              onClick={() => router.push("/admin/hr/reviews/new")}
            >
