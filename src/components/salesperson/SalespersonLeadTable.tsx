...
import { Pencil, Eye, FileText, ChevronDown, Send, CheckCircle2, StickyNote, History, Bell, Calendar, Phone, MessageCircle, Mail, Video, Users } from "lucide-react";
    ...
    return (
      <div className="rounded-md border p-8 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Leads will appear here when they are assigned to you.
        </p>
      </div>
    );
  }
                ...
                <div className="flex items-center justify-center gap-0">
                  ...
                  {onSendMeetingInvite && lead.email && (
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-8 w-8 text-gray-500 hover:text-[hsl(var(--jw-gold-accent))] hover:bg-amber-50"
