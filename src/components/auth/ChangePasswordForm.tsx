    ...
    <form onSubmit={handleChangePassword} className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-xs text-[#777777]">
          {t("portal:settings.passwordRequirements")}
        </p>
      </div>

      <div className="space-y-2">
        <Label htmlFor="confirmPassword" className="text-[#555555]">
          {t("portal:settings.confirmNewPassword")}{" "}
          <span className="text-red-500">*</span>
        </Label>
        <div className="relative">
          <Input
      ...
      <div className="flex items-start gap-2 p-3 bg-[#E6F7F1] rounded-lg border border-[hsl(var(--jw-primary-green))]/20">
        ...
        <p className="text-xs text-[#555555]">
          <strong>{t("portal:settings.securityTip")}</strong>{" "}
          {t("portal:settings.securityTipMessage")}
        </p>
      </div>
