...
CREATE INDEX idx_quarterly_reviews_employee ON quarterly_reviews(employee_id);
CREATE INDEX idx_quarterly_reviews_reviewer ON quarterly_reviews(reviewer_id);
CREATE INDEX idx_quarterly_reviews_status ON quarterly_reviews(status);
CREATE INDEX idx_quarterly_reviews_period ON quarterly_reviews(year, quarter);
CREATE INDEX idx_quarterly_reviews_deadline ON quarterly_reviews(deadline_date);
...
CREATE INDEX idx_review_templates_default ON review_templates(is_default) WHERE is_default = true;
